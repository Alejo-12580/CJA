...
import java.util.*;
	...
	public class Producto {
		...
		public Producto(Integer id, String nombre, String imagen, String estado, String novedades, String disenho, String talla_capacidad, String genero_modelo, String garantia, double precio, int cantidad, Categoria categoria, List<DetalleOrden> detalle, List<DetalleVenta> detalleventa) {
			this.id = id;
			this.nombre = nombre;
			this.imagen = imagen;
			this.estado = estado;
